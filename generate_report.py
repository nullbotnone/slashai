...
for job in report:
    ...
    markdown += f"| {job['id']} | {job['name']} | {job['enabled']} | {job['last_run_status']} | {job['consecutive_errors']} | {job['last_duration_ms']/1000:.2f} | {job['time_since_last_run_ms']/1000:.2f} | {job['interval_ms']/1000:.2f if job['interval_ms'] > 0 else 'N/A'} | {issues_str} |\n"
