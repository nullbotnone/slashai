...
cron_jobs_file = "/home/rpi/.openclaw/workspace/projects/slashai/slashai/projects/slashai/cron_jobs_current.json"
...
def main():
    ...
    if problematic_jobs:
        ...
        for job, issues in problematic_jobs:
            ...
            report_lines.append(f"### {job_name} (ID: {job_id})")
            for issue in issues:
    ...
    if daily_job:
        consecutive_errors = daily_job.get('state', {}).get('consecutiveErrors', 0)
        if consecutive_errors > 0:
            ...
            report_lines.append("Consider manually triggering this job to test if the underlying issue is resolved.")
            report_lines.append("")
