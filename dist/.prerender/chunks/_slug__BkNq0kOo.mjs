...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "ArticleLayout", $$ArticleLayout, { "title": post.data.title, "description": post.data.description, "pubDate": post.data.pubDate, "updatedDate": post.data.updatedDate, "tags": post.data.tags, "collection": "roundups", "slug": slug }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "/home/rpi/.openclaw/workspace/projects/slashai/slashai/src/pages/roundups/[slug].astro", void 0);

const $$file = "/home/rpi/.openclaw/workspace/projects/slashai/slashai/src/pages/roundups/[slug].astro";
const $$url = "/roundups/[slug]";
